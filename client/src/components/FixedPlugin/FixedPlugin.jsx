                    ...
                    <li className="adjustments-line">
                        <div className="badge-colors text-center">
                            <span
                                ...
                                data-color="black"
                                onClick={ () => props.handleBgClick("black") }
                            />
                            <span
                                className={
                                    props.bgColor === "white"
                                ...
                                data-color="white"
                                onClick={ () => props.handleBgClick("white") }
                    ...
                    <li className="adjustments-line">
                        <div className="badge-colors text-center">
                            <span
                                ...
                                data-color="primary"
                                onClick={ () => props.handleActiveClick("primary") }
                            />
                            <span
                                className={
                                ...
                                data-color="info"
                                onClick={ () => props.handleActiveClick("info") }
                            />
                            <span
                                className={
                                ...
                                data-color="success"
                                onClick={ () => props.handleActiveClick("success") }
                            />
                            <span
                                className={
                                ...
                                data-color="warning"
                                onClick={ () => props.handleActiveClick("warning") }
                            />
                            <span
                                className={
                                ...
                                data-color="danger"
                                onClick={ () => props.handleActiveClick("danger") }
                            />
                        </div>
                    </li>
                </ul>
